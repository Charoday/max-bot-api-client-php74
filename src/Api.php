...
class Api
{
    ...
    */
    public function __construct(
        ...
        $this->updateDispatcher = new UpdateDispatcher($this->logger);
    }
    ...
    */
    public function getUpdates($limit = null, $timeout = null, $marker = null, $types = null)
    {
        $query = [
            'limit' => $limit,
            'timeout' => $timeout,
    ...
    * @throws SerializationException
    */
    public function subscribe($url, $secret = null, $updateTypes = null)
    {
    ...
    public function uploadAttachment($type, $filePath)
    {
        ...
        if ($type === UploadType::Audio || $type === UploadType::Video) {
            ...
            if ($type === UploadType::Audio) {
                return AudioAttachmentRequest::fromToken($uploadEndpoint->token);
            } else {
                return VideoAttachmentRequest::fromToken($uploadEndpoint->token);
            }
        }
        ...
        switch ($type) {
            ...
            case UploadType::File:
                ...
                return FileAttachmentRequest::fromToken($uploadResult['token']);
        }
    ...
    * @throws SerializationException
    */
    public function getMessages($chatId, $messageIds = null, $from = null, $to = null, $count = null)
    {
        $query = [
            'chat_id' => $chatId,
    ...
    * @throws SerializationException
    */
    public function getMembers($chatId, $userIds = null, $marker = null, $count = null)
    {
        $query = [
    ...
    * @throws ReflectionException
    */
    private function buildNewMessageBody($text, $attachments, $format, $link, $notify)
    {
        $body = [
            'text' => $text,
