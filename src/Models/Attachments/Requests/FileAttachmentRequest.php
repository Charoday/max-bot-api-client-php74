...
/**
 * Request model for file attachments when sending messages.
 */
class FileAttachmentRequest extends AbstractAttachmentRequest
{
    ...
    {
        parent::__construct(AttachmentType::File, $payload);
    }
}
